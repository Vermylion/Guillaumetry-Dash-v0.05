...
def load_level(win_width, win_height):
    ...
    level_file = open('level.txt', 'r')
    for line in range(lvl_height):
        line = level_file.readline().removesuffix('\n')
        ...
        for tile in line:
            ...
            if tile == 'S':
                draw_spike(level, xoffset, yoffset, 0)
            if tile == 's':
                draw_spike(level, xoffset, yoffset, 0, 'small')
            if tile == '}':
                draw_spike(level, xoffset, yoffset, 270)
            if tile == '>':
                draw_spike(level, xoffset, yoffset, 270, 'small')
            if tile == '{':
                draw_spike(level, xoffset, yoffset, 90)
            if tile == '<':
                draw_spike(level, xoffset, yoffset, 90, 'small')
            if tile == 'V':
                draw_spike(level, xoffset, yoffset, 180)
            if tile == 'v':
                draw_spike(level, xoffset, yoffset, 180, 'small')
            if tile == 'O':
                draw_saw(level, xoffset, yoffset)
            if tile == 'o':
                draw_orb(level, xoffset, yoffset)
            if tile == '_':
                draw_pad(level, xoffset, yoffset)
            if tile == ' ':
                pass
    ...
    return level, player, player_rect_bottom, player_rect_right, player_rect_top, yoffset, lvl_length, list_of_collisions, list_of_collisions_enemy, list_of_collisions_jump_pad, list_of_collisions_jump_orb